...
import 'package:pronet_storeroom_v_01/features/settings/building/widgets/building_list_table.dart';
...
class _BuildingPageState extends State<BuildingPage> {
  final BuildingBloc _buildingBloc = BuildingBloc(
  ...
  Future<void> refreshList() {
    ...
    _buildingBloc.add(LoadBuildingListEvent(
      completer: completer,
      ...
      child: BlocBuilder<BuildingBloc, BuildingState>(
        ...
        builder: (context, state) {
          if (state is BuildingListLoadedState) {
            final buildingList = state.buildingList!;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                        ...
                        child: Text(
                            '${buildingList.length} из ${state.countAll}')),
                    const SizedBox(
                      height: 10,
                    ),
                    if (!isEnd)
                      Center(
                        child: TextButton(
                          onPressed: () {
                            _buildingBloc.add(LoadNextBuildingListEvent());
                          },
